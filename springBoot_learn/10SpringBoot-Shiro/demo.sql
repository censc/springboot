...
INSERT INTO `sys_admin_user` VALUES (18, 'redisTest1', '$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'redis测试用户', 0, '123456', '405780096@qq.com', '', 1, 0, 'string', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', 0, 0, 0, 'redis测试用户');
INSERT INTO `sys_admin_user` VALUES (19, 'redisTest2', '$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'redis测试用户', 0, '123456', '405780096@qq.com', '', 1, 0, 'string', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', 0, 0, 0, 'redis测试用户');
INSERT INTO `sys_admin_user` VALUES (20, 'redisTest3', '$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'redis测试用户', 0, '123456', '405780096@qq.com', '', 1, 0, 'string', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', '2020-11-03 15:47:48', 0, 0, 0, 'redis测试用户');
INSERT INTO `sys_admin_user` VALUES (27, 'testShiro', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'string', 0, 'string', 'string', 'string', 1, 1, 'string', '2020-11-05 16:32:14', '2020-11-05 16:32:14', '2020-11-05 16:32:14', '2020-11-05 16:32:14', 0, 0, 0, 'string');
...
INSERT INTO `sys_menu` VALUES (3, '用户添加', 2, 'system/user/add', 'system:user:add', 0, 0, 0, 1, 2);
INSERT INTO `sys_menu` VALUES (4, '用户编辑', 2, 'system/user/edit', 'system:user:edit', 0, 0, 0, 1, 2);
INSERT INTO `sys_menu` VALUES (5, '用户删除', 2, 'system/user/delete', 'system:user:delete', 0, 0, 0, 1, 2);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '系统管理员', 0, 1, 0, '系统管理员', '2020-10-17 17:17:03', '2020-10-17 17:17:07', NULL, 0, 0, 0, 0);
...
CREATE TABLE `sys_user_role`  (
  ...
  CONSTRAINT `FK9p9tdu5ecj7bsqfk7e3rxwpeo` FOREIGN KEY (`user_id`) REFERENCES `sys_admin_user` (`admin_user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
